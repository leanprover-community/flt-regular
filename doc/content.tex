...
\begin{lemma}\label{lem:gen_ideal_coprimality}
		...
		\begin{enumerate}
			...
			\item Each $\mathfrak{c}_k=\mathfrak{a}_k^p$ and $\mathfrak{a}_k\mathrfrak{a}_0^{-1}$ is principal (as a fractional ideal).
		\end{enumerate}
...
\begin{theorem}\label{thm:gen_flt_eqn}
	\uses{lem:gen_dvd_by_frak_p_lem, lem:gen_ideal_coprimality}
